...
\begin{document}
\section*{2026 届上海市浦东新区高三数学二模}

\begin{center}
\includegraphics[max width=1.0\textwidth]{images/bo_d7ci9f2lb0pc73de9ldg_0_0_1_1374_2337_0.jpg}
\end{center}
\hspace*{3em} 
...
3. 已知 \(f\left( x\right)  = \left\{  \begin{array}{ll} \frac{1}{{x}^{3}}, & x < 0, \\  x + 1, & x \geq  0. \end{array}\right.\) 若 \(f\left( a\right)  =  - 2\) ，则实数 \(a\) 的值为-8\_\_\_\_\_.
...
6. 已知直线 \(l\) 是曲线 \(y = \frac{3}{x + 1} + \ln x\) 在 \(x = 2\) 处的切线,则 \(l\) 的斜率为 \(- \frac{1}{6}\) \_\_\_\_\_.

\({y}^{\prime } =  - \frac{3}{{\left( x + 1\right) }^{2}} + \frac{1}{x},\;k = {y}^{\prime }\left( 2\right)  =  - \frac{3}{{\left( 2 + 1\right) }^{2}} + \frac{1}{2} = \frac{1}{6}\)

7. 从 4 名男生 3 名女生中选取 3 人，依次进行面试，其中恰好有 1 名女生，则有\_\_\_\_\_108\_\_\_\_\_种不同的面试方法. \({C}_{4}^{2}{C}_{3}^{1}{P}_{3}^{3} = {108}\)
...
9. 已知数列 \(\left\{  {a}_{n}\right\}\) 的通项公式是 \({a}_{n} = {2}^{n - 1} + 1,{S}_{n}\) 为数列 \(\left\{  {a}_{n}\right\}\) 的前 \(n\) 项和,则使得不等式 \({S}_{n} > {2026}\) 成立的最小正整数 \(n\) 的值为\_\_\_\_\_11\_\_\_\_\_.
...
10. 已知,圆 \(O\) 是圆心在原点的单位圆,弦 \({AB}\) 平行于 \(x\) 轴,并将圆分为两段弧. 将其中一段劣弧 \(\overset{\text{ ⏜ }}{AB}\) 沿弦 \({AB}\) 翻折后恰好经过圆心. 若直线 \(y = x + m\) 与翻折后得到的两段弧有四个不同的交点,则实数 \(m\) 的取值范围为 \(- \left( {\frac{\sqrt{3} - 1}{2},\sqrt{2} - 1}\right)\) \_\_\_\_\_.

\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d7ci9f2lb0pc73de9ldg_2_1097_1610_379_444_0.jpg}
\end{center}
\hspace*{3em} 
...
11. 某光影科技实验室为长方体空间, 底面是边长为 4 米的正方形, 高为 3 米. 为营造动态光影效果, 在底面一个顶点处安装射灯 \(A\) ,在与该顶点相对的侧棱上、距底面 1 米处安装射灯 \(I\) ,两盖射灯的光束方向由智能系统自动控制,始终使两束光线相互垂直,且它们的交汇点 \(G\) 始终落在实验室天花板上. 则交汇点 \(G\) 形成的轨迹长度为 \(2\sqrt{2}\pi\) \_\_\_\_\_米.

\begin{center}
\includegraphics[max width=0.4\textwidth]{images/bo_d7ci9f2lb0pc73de9ldg_3_931_1110_552_452_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.4\textwidth]{images/bo_d7ci9f2lb0pc73de9ldg_4_136_208_482_363_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.6\textwidth]{images/bo_d7ci9f2lb0pc73de9ldg_4_156_1130_713_349_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.4\textwidth]{images/bo_d7ci9f2lb0pc73de9ldg_6_957_690_515_328_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d7ci9f2lb0pc73de9ldg_7_1056_869_381_276_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d7ci9f2lb0pc73de9ldg_7_1016_1185_447_273_0.jpg}
\end{center}
\hspace*{3em} 
...
\hline
甜度偏好分数 & [4,5) & [5,6) & \(\lbrack 6,7)\) & \(\lbrack 7,8)\) & \(\lbrack 8,9)\) & [9,10] \\
\cline{1-7}
人数 & 10 & 25 & 20 & 30 & 10 & 5 \\
\cline{1-7}
\hline
...
\begin{center}
\includegraphics[max width=0.4\textwidth]{images/bo_d7ci9f2lb0pc73de9ldg_10_1014_741_493_515_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7ci9f2lb0pc73de9ldg_12_1149_1103_342_203_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=1.0\textwidth]{images/bo_d7ci9f2lb0pc73de9ldg_14_53_481_1788_1824_0.jpg}
\end{center}
\hspace*{3em} 
