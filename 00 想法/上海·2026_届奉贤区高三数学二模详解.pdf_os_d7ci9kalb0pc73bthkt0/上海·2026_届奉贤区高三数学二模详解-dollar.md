...
![bo_d7ci9kqlb0pc73de9leg_0_0_1_1374_2337_0.jpg](images/bo_d7ci9kqlb0pc73de9leg_0_0_1_1374_2337_0.jpg)

## 一、填空题(本题共 12 小题，1-6 每小题 4 分，7-12 每小题 5 分，共 54 分.)

1. 已知集合 $A = \{ {3a}\} , B = \left\{  {9,{a}^{2}}\right\}$ ，若 $A \subseteq  B$ ，则实数 $a =$ ___0___.

${3a} = 9, a = 3,{a}^{2} = 9$ (舍)

${3a} = {a}^{2},\;a = 0$

2. 不等式 $\left| {x - 2}\right|  > 1$ 的解集为 $\left( {-\infty ,1}\right)  \cup  \left( {3, + \infty }\right)$ ___.

$x - 2 > 1$ 或 $x - 2 <  - 1, x \in  \left( {-\infty ,1}\right)  \cup  \left( {3, + \infty }\right)$

3. ${\left( x + \frac{1}{x}\right) }^{5}$ 的展开式中 $x$ 的系数为___10___.

${C}_{5}^{2}{x}^{3}{\left( \frac{1}{x}\right) }^{2} = {10x}$

4. 若直线 $\left( {a - 1}\right) x + y - 1 = 0$ 与直线 ${3x} - y = 0$ 平行,则实数 $a$ 的值为___2___. $\frac{a - 1}{3} = \frac{1}{7},\;a =  - 2$

5. 已知圆锥的高为 8 ，底面半径为 6 ，则该圆锥的侧面积为___60π___.

${S}_{\left( n\right) } = {\pi rl} = {60\pi }$

![bo_d7ci9kqlb0pc73de9leg_1_668_1379_193_197_0.jpg](images/bo_d7ci9kqlb0pc73de9leg_1_668_1379_193_197_0.jpg)

6. 已知函数 $y = \left\{  \begin{array}{l} x\left( {x - b}\right) , x \geq  0, \\  x\left( {{bx} + 1}\right) , x < 0. \end{array}\right.$ 是奇函数,则 $b = \_  - 1$ _____.
...
7. 某食品厂生产一种零食,该种零食每袋的质量 $X$ (单位: $\mathrm{g}$ ) 服从正态分布 $N\left( {{65},{2.2}^{2}}\right)$ ,记作 $X \sim  N\left( {{65},{2.2}^{2}}\right)$ . 规定: 这种零食的质量在 ${62.8} \sim  {69.4}\mathrm{\;g}$ 之间的为合格品; 则这种零食的合格率为 ___0.819___. (结果精确到 0.001)
...
![bo_d7ci9kqlb0pc73de9leg_2_1139_660_495_248_0.jpg](images/bo_d7ci9kqlb0pc73de9leg_2_1139_660_495_248_0.jpg)
...
8. 点 $F$ 为抛物线 $C : {y}^{2} = {8x}$ 的焦点， $P$ 为 $C$ 上一点，若 $\bigtriangleup {POF}$ 的面积为 $4\sqrt{2}$ ( $O$ 为坐标原点)，则 $\left| {PF}\right|  =$ ___6___.

![bo_d7ci9kqlb0pc73de9leg_2_856_1169_325_283_0.jpg](images/bo_d7ci9kqlb0pc73de9leg_2_856_1169_325_283_0.jpg)
...
10. 已知复数 $z = \cos \theta  + \mathrm{i}\sin \theta ,\theta  \in  \lbrack 0,{2\pi }),\mathrm{i}$ 是虚数单位,则 ${\left| z + 6\right| }^{2} + {\left| z - 8\mathrm{i}\right| }^{2}$ 的取值范围是___ $\left\lbrack  {{82},{122}}\right\rbrack$ ___. $Z\left( {\cos \theta ,\sin \theta }\right)  = \left( {x, y}\right) ,{x}^{2} + {y}^{2} = 1$
...
$\beta  = {38.2}^{ \circ  },\gamma  = {25.1}^{ \circ  }$ . 计划沿直线 ${AC}$ 开通穿山隧道,为了求出隧道 $\overset{\text{ ⏜ }}{DE}$ 的长度,还测得 ${AD} = {277}$ 米, ${BE} = {49}$ 米， ${BC} = {320}$ 米，则根据以上数据，隧道 ${DE}$ 的长度约为___805___米.(结果精确到 1 米)

![bo_d7ci9kqlb0pc73de9leg_3_173_346_449_188_0.jpg](images/bo_d7ci9kqlb0pc73de9leg_3_173_346_449_188_0.jpg)
...
![bo_d7ci9kqlb0pc73de9leg_3_1191_1585_433_425_0.jpg](images/bo_d7ci9kqlb0pc73de9leg_3_1191_1585_433_425_0.jpg)
...
## 二、选择题(本题共 4 小题，13-14 每小题 4 分，15-16 每小题 5 分，共 18 分. 在每小题给出的 四个选项中, 只有一项是符合题目要求的.)
...
![bo_d7ci9kqlb0pc73de9leg_4_154_1515_238_190_0.jpg](images/bo_d7ci9kqlb0pc73de9leg_4_154_1515_238_190_0.jpg)

音叉

![bo_d7ci9kqlb0pc73de9leg_4_399_1512_289_193_0.jpg](images/bo_d7ci9kqlb0pc73de9leg_4_399_1512_289_193_0.jpg)

图1

![bo_d7ci9kqlb0pc73de9leg_4_702_1543_313_154_0.jpg](images/bo_d7ci9kqlb0pc73de9leg_4_702_1543_313_154_0.jpg)

图2

![bo_d7ci9kqlb0pc73de9leg_4_1023_1537_304_168_0.jpg](images/bo_d7ci9kqlb0pc73de9leg_4_1023_1537_304_168_0.jpg)
...
![bo_d7ci9kqlb0pc73de9leg_5_722_994_253_185_0.jpg](images/bo_d7ci9kqlb0pc73de9leg_5_722_994_253_185_0.jpg)
...
![bo_d7ci9kqlb0pc73de9leg_5_726_1202_252_180_0.jpg](images/bo_d7ci9kqlb0pc73de9leg_5_726_1202_252_180_0.jpg)
...
![bo_d7ci9kqlb0pc73de9leg_5_737_1433_248_174_0.jpg](images/bo_d7ci9kqlb0pc73de9leg_5_737_1433_248_174_0.jpg)
...
## 三、解答题(本题共 5 小题，17-19 题每题 14 分，20-21 题每题 18 分，共 78 分. 解答应写出文 字说明, 证明过程或演算步骤.)
...
![bo_d7ci9kqlb0pc73de9leg_7_520_1216_300_275_0.jpg](images/bo_d7ci9kqlb0pc73de9leg_7_520_1216_300_275_0.jpg)

图2

![bo_d7ci9kqlb0pc73de9leg_7_153_1216_282_261_0.jpg](images/bo_d7ci9kqlb0pc73de9leg_7_153_1216_282_261_0.jpg)
...
![bo_d7ci9kqlb0pc73de9leg_8_1071_654_477_468_0.jpg](images/bo_d7ci9kqlb0pc73de9leg_8_1071_654_477_468_0.jpg)
...
![bo_d7ci9kqlb0pc73de9leg_9_928_1093_487_403_0.jpg](images/bo_d7ci9kqlb0pc73de9leg_9_928_1093_487_403_0.jpg)
...
![bo_d7ci9kqlb0pc73de9leg_11_1326_532_294_333_0.jpg](images/bo_d7ci9kqlb0pc73de9leg_11_1326_532_294_333_0.jpg)
...
![bo_d7ci9kqlb0pc73de9leg_12_1015_339_381_241_0.jpg](images/bo_d7ci9kqlb0pc73de9leg_12_1015_339_381_241_0.jpg)
...
![bo_d7ci9kqlb0pc73de9leg_13_53_481_1788_1824_0.jpg](images/bo_d7ci9kqlb0pc73de9leg_13_53_481_1788_1824_0.jpg)