...
![bo_d7ci95alb0pc73de9la0_0_0_1_1374_2337_0.jpg](images/bo_d7ci95alb0pc73de9la0_0_0_1_1374_2337_0.jpg)

## 一、填空题

1. 已知集合 $A = \left\{  {a,{a}^{2}}\right\}$ ，且 $1 \in  A$ ，则 $a =$ ___-1___

![bo_d7ci95alb0pc73de9la0_1_765_504_259_256_0.jpg](images/bo_d7ci95alb0pc73de9la0_1_765_504_259_256_0.jpg)

${a}^{2} = 1,\;a \neq  1$

$\therefore a =  - 1$

2. 不等式 $\frac{1}{x} > 1$ 的解集是___ $\left( {0,1}\right)$ ___

3. 已知角 $\alpha$ 的终边经过点 $P\left( {1, - 2}\right)$ ，则 $\sin \alpha  =$ ___ $- \frac{2\sqrt{5}}{5}$ ___

$\sin \alpha  = \frac{y}{r} = \frac{-2}{\sqrt{5}} =  - \frac{2\sqrt{5}}{5}$

4. 已知 $\left\{  {a}_{n}\right\}$ 是等差数列， ${a}_{6} = 1,{a}_{26} = {11}$ ，则 ${a}_{2026} =$ ___1011___

${a}_{26} = {a}_{6} + {20d},\;{11} = 1 + {20d},\;d = \frac{1}{2}$

${a}_{2026} = {a}_{6} + {2020d} = 1 + {2020} \times  \frac{1}{2} = {1011}$

5. 双曲线 $\frac{{x}^{2}}{9} - \frac{{y}^{2}}{16} = 1$ 的渐近线方程为___ $y =  \pm  \frac{4}{3}x$ ___

6. 用 $0\text{ 、 }1\text{ 、 }2\text{ 、 }3\text{ 、 }4$ 可以组成的没有重复数字的三位数的个数是___48___

$4{P}_{4}^{2} = {48}$

7. 函数 $y = {\sin }^{4}x + {\cos }^{4}x$ 的最小正周期是___ $\frac{\pi }{2}$ ___
...
![bo_d7ci95alb0pc73de9la0_2_470_745_366_288_0.jpg](images/bo_d7ci95alb0pc73de9la0_2_470_745_366_288_0.jpg)

10. 已知正四面体上的四个面上分别写有 $1\text{ 、 }2\text{ 、 }3\text{ 、 }4$ ,游戏中甲、乙轮流抛掷该四面体,谁抛出底面数字等于 4 则获胜且游戏结束,甲先开始,则甲获胜的概率为___ $\frac{4}{7}$ ___
...
11. 将函数 $y = {x}^{2}, x \in  \left\lbrack  {0,1}\right\rbrack$ 的图像绕坐标原点逆时针方向旋转角 $\theta \left( {0 \leq  \theta  \leq  \alpha }\right)$ 得到曲线 $\mathrm{C}$ ,若对于每一个角 $\theta$ ,曲线 $\mathrm{C}$ 都是一个函数的图像,则 $\alpha$ 的最大值为___ $\arctan \frac{1}{2}$ ___
...
![bo_d7ci95alb0pc73de9la0_3_843_348_301_272_0.jpg](images/bo_d7ci95alb0pc73de9la0_3_843_348_301_272_0.jpg)
...
12. 在包装设计中,常用长度和宽度描述物体体型,长度 $l\left( V\right)$ 定义为物体上最远两点间的距离, 宽度 $t\left( V\right)$ 定义为能夹住物体的两平行平面间的最小距离,即存在一对平行平面,使得物体上的所有点均位于两平面之间 (包括平面上),现有一圆柱,其底面半径 $\mathrm{R}$ 与高 $\mathrm{h}$ 可任意调节,则 $\frac{l\left( V\right) }{t\left( V\right) }$ 的最小值为___ $\sqrt{2}$ ___
...
![bo_d7ci95alb0pc73de9la0_3_968_1372_290_338_0.jpg](images/bo_d7ci95alb0pc73de9la0_3_968_1372_290_338_0.jpg)
...
<table><tr><td>动物名</td><td>体重 W/(g)</td><td>脉搏率 $f/\left( {\text{ 次 } \cdot  {\mathrm{{min}}}^{-1}}\right)$</td></tr><tr><td>鼠</td><td>25</td><td>670</td></tr><tr><td>豚鼠</td><td>300</td><td>300</td></tr><tr><td>兔</td><td>2000</td><td>205</td></tr><tr><td>小狗</td><td>5000</td><td>120</td></tr><tr><td>大狗</td><td>30000</td><td>85</td></tr><tr><td>羊</td><td>50000</td><td>70</td></tr><tr><td>马</td><td>450000</td><td>38</td></tr></table>
...
![bo_d7ci95alb0pc73de9la0_6_964_294_385_280_0.jpg](images/bo_d7ci95alb0pc73de9la0_6_964_294_385_280_0.jpg)
...
![bo_d7ci95alb0pc73de9la0_6_978_1127_292_284_0.jpg](images/bo_d7ci95alb0pc73de9la0_6_978_1127_292_284_0.jpg)
...
![bo_d7ci95alb0pc73de9la0_6_906_1463_401_417_0.jpg](images/bo_d7ci95alb0pc73de9la0_6_906_1463_401_417_0.jpg)
...
参考公式与数据: ① 若 $X \sim  N\left( {\mu ,{\sigma }^{2}}\right)$ ,则 $Z = \frac{X - \mu }{\sigma } \sim  N\left( {0,1}\right)$
...
![bo_d7ci95alb0pc73de9la0_7_844_1621_476_239_0.jpg](images/bo_d7ci95alb0pc73de9la0_7_844_1621_476_239_0.jpg)
...
![bo_d7ci95alb0pc73de9la0_8_902_1414_499_360_0.jpg](images/bo_d7ci95alb0pc73de9la0_8_902_1414_499_360_0.jpg)
...
![bo_d7ci95alb0pc73de9la0_10_1065_830_394_252_0.jpg](images/bo_d7ci95alb0pc73de9la0_10_1065_830_394_252_0.jpg)
...
![bo_d7ci95alb0pc73de9la0_10_979_1187_474_313_0.jpg](images/bo_d7ci95alb0pc73de9la0_10_979_1187_474_313_0.jpg)
...
![bo_d7ci95alb0pc73de9la0_11_53_481_1788_1824_0.jpg](images/bo_d7ci95alb0pc73de9la0_11_53_481_1788_1824_0.jpg)