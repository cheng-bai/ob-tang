...
【知识点 3】若 \(p \Rightarrow  q\) ，则 p 是 q 的\_\_\_\_\_条件；q 是 p 的\_\_\_\_\_条件。

【答案】充分, 必要.

\section*{1.1 集合运算}

1.【2025.12 虹口高三一模 1】已知集合 \(A = \{ x\begin{Vmatrix}{x - 1}\end{Vmatrix} < 2\} ,B = \{ x \mid  x > 0\}\) ，则 \(A \cap  B =\) \_\_\_\_\_.

2.【2025.12 青浦高三一模 1】已知集合 \(A = \{ x \mid   - 1 \leq  x \leq  3\} ,B = \{ x \mid  x \leq  0\}\) ，则 \(A \cap  B =\) \_\_\_\_\_.

3.【2025.12 松江高三一模 1】已知集合 \(A = \left( {-1,5}\right) ,B = \{ x \mid   - 2 < x < 2\}\) ，则 \(A \cap  B =\) \_\_\_\_\_.

4.【2025.12 普陀高三一模 1】已知集合 \(A = \{ x\parallel x \mid   \leq  1\} ,B = \{  - 2, - 1,0,1,2\}\) ，则 \(A \cap  B =\) \_\_\_\_\_.

5.【2025.12 浦东高三一模 1】已知集合 \(A = \{ x \mid  x > 1\}\) ，集合 \(B = \{ 1,2,3\}\) ，则 \(A \cap  B =\) \_\_\_\_\_.
...
8.【2025.12 长宁高三一模 1】集合 \(A = \left( {0, + \infty }\right)\) ，集合 \(B = \{  - 2, - 1,0,1,2\}\) ，则 \(A \cap  B =\) \_\_\_\_\_.
...
11.【2025.12 宝山高三一模 1】若全集 \(U = \{ 1,2,3,4,5,6\}\) ，集合 \(A = \{ 1,3,5,6\}\) ，则 \(\bar{A} =\) \_\_\_\_\_.

12.【2025.12 静安高三一模 1】已知全集是实数集 \(\mathbb{R}\) ,集合 \(M = \{ x \mid  \left( {x - 3}\right) \left( {x + 2}\right)  \geq  0\}\) ,则集合 \(M\) 的补集 \(\bar{M} =\) \_\_\_\_\_.

13.【2025.12 闵行高三一模 1】已知全集 \(U = \{  - 2, - 1,0,1,2\}\) ，集合 \(A = \{  - 2, - 1,0\}\) ，则 \(\bar{A} =\) \_\_\_\_\_.

14.【2025.12 徐汇高三一模 2】设集合 \(A = \left( {-2,2}\right) ,B = \left( {1, + \infty }\right)\) ，则. \(A \cap  B =\) .\_\_\_\_\_.

15.【2025.12 黄浦高三一模 3】已知集合 \(A = \{ x\left| {\;x <  - 1}\right.\) 或 \(x > 4\} ,\;B = \{ x\parallel x + 1 \mid   < 1,x \in  \mathbb{R}\}\) ,则 \(A \cap  B =\) \_\_\_\_\_.
...
4.【2025.12 金山高三一模 6】已知 \(\lg 2 = a\) ， \(\lg 3 = b\) ，则 \({\log }_{4}6 =\) \_\_\_\_\_. (用 \(a\) 和 \(b\) 表示)
...
(1)判断下列两个函数是否为其定义域上的“ \(U\) 函数”(不需要说明理由);  \circled{1}  \(y = \sin x,x \in  \left( {0,\frac{\pi }{2}}\right)\) ;  \circled{2}  \(y = {x}^{2} + {2x}\) .
...
1.【2025.12 金山高三一模 2】已知角 \(\alpha\) 为第二象限角,且 \(\sin \alpha  = \frac{3}{5}\) ,则 \(\cos \alpha  =\) \_\_\_\_\_.
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_22_1118_1231_279_370_0.jpg}
\end{center}
\hspace*{3em} 

\section*{4.3 函数性质}

1.【2025.12 杨浦高三一模 2】函数 \(y = 3\sin \left( {{2x} + \frac{\pi }{6}}\right)\) 的最小正周期为\_\_\_\_\_.
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_28_1059_675_343_269_0.jpg}
\end{center}
\hspace*{3em} 
...
3.【2025.12 闵行高三一模 8】已知 \(\left\{  {a}_{n}\right\}\) 是等比数列,若 \({a}_{1}\text{ 、 }{a}_{5}\) 是函数 \(y = {x}^{2} + {3x} + 1\) 的两个零点,则 \({a}_{3} =\) \_\_\_\_\_.
...
2.【2025.12 崇明高三一模 12】设 \(M = \left\{  {x \mid  1 \leq  x \leq  {20},x \in  \mathbf{N}}\right\}\) . 数列 \(\left\{  {a}_{n}\right\}\) 满足下列条件: \({a}_{1} = 1\) , \({a}_{20} = 5,{a}_{k + 1} - {a}_{k} \in  \{ 0,1\}\) ,且对任意的 \(i,j \in  M\) ,都存在 \(m,n \in  M\) 使得 \({a}_{i} + {a}_{j} = {a}_{m} + {a}_{n}\) ,其中 \(i,j,m,n\) 互不相等,则数列 \(\left\{  {a}_{n}\right\}\) 的前 20 项和的最大值是\_\_\_\_\_.
...
10.【2025.12 虹口高三一模 16】若每一项均为正数的数列 \(\left\{  {a}_{n}\right\}\) 的前 \(n\) 项和为 \({S}_{n}\) ,且对于任意的正整数 \(n\) ,均存在正整数 \(m\) 使得 \(\frac{{a}_{n} - {S}_{m}}{{a}_{n} - {S}_{m + 1}} \leq  0\) ,则称 \(\left\{  {a}_{n}\right\}\) 具有“ \(P\) 性质”. 对于以下命题, 说法正确的是( )
 ...
 \circled{2}  若 \(\left\{  {a}_{n}\right\}\) 具有“ \(P\) 性质”，记 \({\Delta }_{n} = {S}_{m + 1} - {a}_{n}\) 且 \(\left\{  {\Delta }_{n}\right\}\) 为等差数列，则 \({S}_{n} \leq  {2}^{n} \cdot  {a}_{1} \cdot\)
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d6dcemn7aajc739b59g0_40_1047_405_353_183_0.jpg}
\end{center}
\hspace*{3em} 
...
\cline{1-5}
\multicolumn{2}{|c|}{图形} & \includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_43_712_1383_210_183_0.jpg} & \includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_43_961_1392_187_181_0.jpg} & \includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_43_1199_1392_168_173_0.jpg} \\
\cline{1-5}
...
\phantom{X} & 图形 & 量的关 \\
\cline{1-3}
相离 & \includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_44_579_926_217_156_0.jpg} & \(d > {r}_{1} + {r}_{2}\) \\
\cline{1-3}
外切 & \includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_44_575_1102_219_162_0.jpg} & \(d = {r}_{1} + {r}_{2}\) \\
\cline{1-3}
相交 & \includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_44_587_1281_202_155_0.jpg} & \(\left| {{r}_{1} - {r}_{2}}\right|  < d < {r}_{1} + {r}_{2}\) \\
\cline{1-3}
内切 & \includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_44_577_1461_208_175_0.jpg} & \(d = \left| {{r}_{1} - {r}_{2}}\right|\) \\
\cline{1-3}
内含 & \includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_44_581_1666_194_162_0.jpg} & \(d < \left| {{r}_{1} - {r}_{2}}\right|\) \\
\cline{1-3}
\hline
\end{tabular}
}
...
2.【2025.12 嘉定高三一模 2】已知直线 \(l\) 经过点 \(\left( {-1, - 1}\right)\) 、 \(\left( {2,2}\right)\) ，则 \(l\) 的倾斜角为\_\_\_\_\_.
...
7.【2025.12 普陀高三一模 9】设 \(m \in  \mathbf{R}\) ，直线 \(l : {2x} + y + m = 0\) 经过点 \(P\) ，若向量 \(\overrightarrow{PQ} = \left( {1,3}\right)\) ， 则点 \(Q\) 到直线 \(l\) 的距离为\_\_\_\_\_.
...
\hline
\multicolumn{2}{|c|}{条件} & \multicolumn{2}{|c|}{\({2a} > {2c},{a}^{2} = {b}^{2},a > 0,b > 0,c > 0\)} \\
\cline{1-4}
\multicolumn{2}{|c|}{图像} & \includegraphics[max width=0.3\textwidth]{images/bo_d6dcemn7aajc739b59g0_46_501_1824_361_267_0.jpg} & \includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_46_1001_1801_332_327_0.jpg} \\
\cline{1-4}
 &  &  &  \\
\cline{1-4}
\multirow{9}{*}{几何性质} & 焦点坐标 & \({F}_{1}\left( {-c,0}\right) ,\;{F}_{2}\left( {c,0}\right)\) & \({F}_{1}\left( {0, - c}\right) ,\;{F}_{2}\left( {0,c}\right)\) \\
\cline{2-4}
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d6dcemn7aajc739b59g0_48_989_978_402_306_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d6dcemn7aajc739b59g0_49_968_685_419_331_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.4\textwidth]{images/bo_d6dcemn7aajc739b59g0_52_329_773_520_364_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.4\textwidth]{images/bo_d6dcemn7aajc739b59g0_52_860_804_544_333_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.4\textwidth]{images/bo_d6dcemn7aajc739b59g0_52_328_1332_506_332_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.4\textwidth]{images/bo_d6dcemn7aajc739b59g0_52_899_1335_502_329_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d6dcemn7aajc739b59g0_56_982_675_422_261_0.jpg}
\end{center}
\hspace*{3em} 
...
\cline{1-4}
\multicolumn{2}{|c|}{图像} & \includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_58_514_1098_329_293_0.jpg} & \includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_58_1009_1078_306_324_0.jpg} \\
\cline{1-4}
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d6dcemn7aajc739b59g0_60_437_934_400_343_0.jpg}
\end{center}
\hspace*{3em} 

\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_60_930_946_236_314_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.4\textwidth]{images/bo_d6dcemn7aajc739b59g0_61_870_778_531_491_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d6dcemn7aajc739b59g0_62_1005_770_397_378_0.jpg}
\end{center}
\hspace*{3em} 
...
\cline{1-5}
图形 & \includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_65_485_767_155_167_0.jpg} & \includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_65_721_771_162_153_0.jpg} & \includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_65_970_773_145_150_0.jpg} & \includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_65_1193_766_177_165_0.jpg} \\
\cline{1-5}
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d6dcemn7aajc739b59g0_68_985_679_413_388_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d6dcemn7aajc739b59g0_69_934_915_439_299_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d6dcemn7aajc739b59g0_73_1044_1050_351_259_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_73_1042_1610_337_253_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_74_1128_843_260_230_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_75_1072_1526_326_304_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_76_1096_722_311_398_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_78_1161_646_238_321_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_79_1083_666_310_360_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_79_1105_1574_283_371_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_80_1104_397_303_420_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_80_1054_1453_343_315_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d6dcemn7aajc739b59g0_81_1030_548_371_301_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_81_1052_1571_301_321_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_82_1118_1442_276_286_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_83_1066_427_329_275_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_83_1074_1495_330_281_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_84_1124_555_281_239_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_84_1066_1512_338_320_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_85_1078_615_326_290_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_85_1050_1589_331_324_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d6dcemn7aajc739b59g0_86_1004_465_367_329_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d6dcemn7aajc739b59g0_86_1045_1599_360_273_0.jpg}
\end{center}
\hspace*{3em} 
...
2.【2025.12 奉贤高三一模 6】从 3 位女生，4 位男生中选 3 人参加科技比赛，只有 1 位女生入选，则不同的选法有\_\_\_\_\_种。(用数字表示答案)

3.【2025.12 金山高三一模 8】某学校读书节活动中, 甲、乙、丙 3 个班级各有 2 位同学获奖，现将这 6 人排成一排拍照，则同一班级的两位同学均站在一起的排法共有\_\_\_\_\_种.
...
现需要按顺序记录某个道路口 5 个时段的信号灯状态,例如,记号 \(\left( {1,0, - 1,0,1}\right)\) 表示 5 个时段中有 3 个时段是 “非正常绿波协调”状态，分别发生在第 1、3、5 时段. 问:该路口 5 个时段所有可能的记录中，“非正常绿波协调”的时段数不少于1个且不多于3个的记录共有\_\_\_\_\_种.
...
10.【2025.12 黄浦高三一模 5】若 \({\left( x + a\right) }^{6}\) 的展开式中 \({x}^{3}\) 的系数为 160,则实数 \(a =\) \_\_\_\_\_.
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d6dcemn7aajc739b59g0_93_599_2003_452_98_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{tabular}{|c|c|c|c|}
\hline
\multicolumn{2}{|c|}{表一} & \multicolumn{2}{|c|}{表二} \\
\cline{1-4}
产业链层级 & 企业数量(家) & 年份 & 市场规模(亿元) \\
\cline{1-4}
\multirow{2}{*}{第一层基础} & \multirow{2}{*}{1820} & 2021 & 800.2 \\
\cline{3-4}
 &  & 2022 & 1200.3 \\
\cline{1-4}
\multirow{2}{*}{第二层模型框架} & \multirow{2}{*}{1590} & 2023 & 1848.5 \\
\cline{3-4}
 &  & 2024 & 2600.6 \\
\cline{1-4}
第三层应用 & 1890 & 2025 & 3500.4 \\
\cline{1-4}
\hline
\end{tabular}
}
...
2.【2025.12 闵行高三一模 5】某公司有 200 名员工，其中有一般人员120人，管理人员32 人，专业技术人员 48 人，现用分层抽样的方法抽取 25 人，以调查大家对职业培训的意愿， 则应抽取的专业技术人员的人数是\_\_\_\_\_.

3.【2025.12 徐汇高三一模 6】相关部门在上海市随机调查了 10 户居民六月份的用电量 (单位:kW·h)，从小到大排列依次为 31、74、78、99、101、107、127、131、208、 223，则这 10 户居民用电量的第 75 百分位数为\_\_\_\_\_.
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d6dcemn7aajc739b59g0_101_1045_1765_357_205_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_104_1149_944_255_252_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.6\textwidth]{images/bo_d6dcemn7aajc739b59g0_105_476_792_759_395_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.4\textwidth]{images/bo_d6dcemn7aajc739b59g0_106_924_827_481_344_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.4\textwidth]{images/bo_d6dcemn7aajc739b59g0_107_885_810_519_337_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.7\textwidth]{images/bo_d6dcemn7aajc739b59g0_108_518_600_900_401_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_110_1127_390_278_142_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_110_1226_746_153_292_0.jpg}
\end{center}
\hspace*{3em} 
...
\cline{1-5}
[151.5,154.5) & 3 & \phantom{X} & 0.05 & 3 \\
\cline{1-5}
[154.5,157.5) & \phantom{X} & \phantom{X} & 0.09 & 9 \\
\cline{1-5}
[157.5,160.5) & \phantom{X} & \phantom{X} & 0.09 & 15 \\
\cline{1-5}
[160.5,166.5) & \phantom{X} & \phantom{X} & \phantom{X} & 19 \\
\cline{1-5}
[163.5,166.5) & \phantom{X} & \phantom{X} & \phantom{X} & 31 \\
\cline{1-5}
...
\begin{center}
\includegraphics[max width=0.5\textwidth]{images/bo_d6dcemn7aajc739b59g0_111_812_1369_596_278_0.jpg}
\end{center}
\hspace*{3em} 
...
\hline
\multicolumn{5}{|c|}{甲} & \phantom{X} & 乙 & \phantom{X} & \phantom{X} & \phantom{X} & \phantom{X} \\
\cline{1-11}
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d6dcemn7aajc739b59g0_116_973_542_429_180_0.jpg}
\end{center}
\hspace*{3em} 
...
4.【 2025.12 嘉定高三一模 3】已知复数 \(z = \frac{3 - {4i}}{4 + {3i}}\) ( \(i\) 为虚数单位)，则 \(\left| z\right|  =\) \_\_\_\_\_.

5.【2025.12 青浦高三一模 3】若复数 \(z = \frac{3 - {5i}}{1 - \mathrm{i}}\) ，则 \(\left| z\right|  =\) \_\_\_\_\_.

6.【2025.12 金山高三一模 3】若复数 \(z\) 满足 \(z \cdot  i = \frac{2}{1 + i}\) ，则 \(\left| z\right|  =\) \_\_\_\_\_.
...
11.【2025.12 虹口高三一模 6】已知复数 \(z\) 是实系数一元二次方程 \({x}^{2} + {bx} + 2 = 0\) 的一个虚数根，则 \(\left| \overrightarrow{z}\right|  =\) \_\_\_\_\_.
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_132_1065_767_336_253_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_132_1026_1605_317_236_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_133_1058_488_340_254_0.jpg}
\end{center}
\hspace*{3em} 
...
5.【2025.12 金山高三一模 11】上海护珠塔, 俗称斜塔, 始建于北宋元丰年间(1078\textasciitilde 1085 年), 是世界上倾斜程度最大的佛塔之一, 其倾斜角 (塔身所在直线与铅垂线的夹角) 超过意大利比萨斜塔. 如图, 护珠塔前有一条笔直的山路, 山路所在直线与水平面夹角为 \({34}^{ \circ  }\) . 康同学为了测量护珠塔的倾斜程度,实施如下方案: 从塔底 \(A\) 沿着山路往下走至 \(B\) ,此时测得 \({AB}\) 长度为 10 米,观察塔顶 \(D\) 的仰角 (视线与水平面的夹角) 为 \({76}^{ \circ  }\) ,继续往下走至 \(C\) , 测得 \({AC}\) 长度为 25.9 米,观察塔顶 \(D\) 的仰角为 \({60}^{ \circ  }\) . 根据康同学的数据,可得该塔的倾斜角为\_\_\_\_\_. (精确到 \({0.1}^{ \circ  }\) )

\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_133_1214_1852_191_248_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.4\textwidth]{images/bo_d6dcemn7aajc739b59g0_134_909_1616_483_357_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d6dcemn7aajc739b59g0_135_974_796_426_329_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d6dcemn7aajc739b59g0_137_1048_1125_349_341_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d6dcemn7aajc739b59g0_138_1016_636_384_337_0.jpg}
\end{center}
\hspace*{3em} 
