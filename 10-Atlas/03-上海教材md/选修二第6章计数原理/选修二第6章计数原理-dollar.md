...
![bo_d4slon3ef24c73be0qm0_0_8_4_1646_1164_0.jpg](images/bo_d4slon3ef24c73be0qm0_0_8_4_1646_1164_0.jpg)
...
定义 ${Mn}$ 个互不相同的元素中,取出 $m\left( {m \leq  n}\right)$ 个不同元素的所有组合的个数,叫做从 $n$ 个元素中取出 $m$ 个元素的组合数,用符号 ${\mathbf{C}}_{n}^{m}$ 表示. Q
