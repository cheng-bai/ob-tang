...
如下图, 在凸四边形 ABCD 中, AC 平分 ∠BAD , 点 EF 分别在边 BC, CD 上, 满足 EF //BD。分别延长FA, EA至点P, Q，使得过点A, B, P的圆 ${\omega }_{1}$ 及过点A, D, Q的圆 ${\omega }_{2}$ 均与直线相切。证明: $B, P, Q, D$ 四点共圆。

![bo_d5206bf7aajc73fu47c0_0_656_990_337_310_0.jpg](images/bo_d5206bf7aajc73fu47c0_0_656_990_337_310_0.jpg)
...
很多竞赛平面几何都需要重构要素关系网，一个策略是尽量把重要且复杂的要素放到前面。本题的两个圆显然是最重要的核心要素,而且两圆被 $\mathrm{A},\mathrm{B},\mathrm{D}$ 直属控制。因此尝试首先画它们:过 $\mathrm{A}$ 的一条直线与两个切圆 ${\omega }_{1}$ ， ${\omega }_{2}$ ，从 $\mathrm{A}$ 光翼展开一对平分线，生出 $\mathrm{B},\mathrm{D}$ 。

![bo_d5206bf7aajc73fu47c0_1_546_513_572_244_0.jpg](images/bo_d5206bf7aajc73fu47c0_1_546_513_572_244_0.jpg)
...
平行于 BD 这一条件还得带着。但是接下来只需要让 BE, DF 交出合法的 C 即可。换而言之, 只要 BE, DF 与 A的“中轴线”三线共点, 那么这一组 EF 就合法!

![bo_d5206bf7aajc73fu47c0_1_866_1339_285_259_0.jpg](images/bo_d5206bf7aajc73fu47c0_1_866_1339_285_259_0.jpg)
...
当有了如上构造的 $\mathrm{E},\mathrm{F}$ 时,设线段 $\mathrm{{EA}},\mathrm{{FA}}$ 与 $\mathrm{{BD}}$ 分别交于 $\mathrm{M},\mathrm{N}$ 。仿照之前的“平行加中轴线”模型推理,可知当且仅当 $\frac{\mathrm{{MT}}}{\mathrm{{NT}}} = \frac{\mathrm{{ES}}}{\mathrm{{FS}}} = \mathrm{k}$ 时,反向从 $\mathrm{{AM}},\mathrm{{AN}}$ 出发,射到一条平行于 $\mathrm{{BD}}$ 的直线上,才能得到合法的一对 $\mathrm{E},\mathrm{F}$ 。

![bo_d5206bf7aajc73fu47c0_2_581_899_529_312_0.jpg](images/bo_d5206bf7aajc73fu47c0_2_581_899_529_312_0.jpg)
...
$$
\left( {\frac{NT}{ND} = \frac{MT}{MB}}\right) \text{ or }\left( {TN}\right) N\left( {TM}\right)
$$

![bo_d5206bf7aajc73fu47c0_2_426_1546_281_320_0.jpg](images/bo_d5206bf7aajc73fu47c0_2_426_1546_281_320_0.jpg)
...
一切都在 “明示” 我们证这个。根据刚才分离左右的策略, 我们选取同一法: 让 BP 与中轴线交于 ${\mathrm{G}}_{1}$ ,计算 ${\mathrm{G}}_{1}$ 的位置。利用对称性立刻得到 $\mathrm{{DQ}}$ 与中轴线交点 ${\mathrm{G}}_{2}$ 的位置。如果两个位置重合, 则猜想成立, 从而本题全部得证。

![bo_d5206bf7aajc73fu47c0_3_498_1253_675_374_0.jpg](images/bo_d5206bf7aajc73fu47c0_3_498_1253_675_374_0.jpg)
