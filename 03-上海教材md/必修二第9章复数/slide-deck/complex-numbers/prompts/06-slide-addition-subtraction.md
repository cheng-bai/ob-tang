---
title: 06-slide-addition-subtraction
来源: 沪教版教材
---
...
**Narrative Goal**: 展示复数加减法的规则，类比多项式运算

**Key Content**:
- Headline: 复数的加减法
- Formula: (a+bi) ± (c+di) = (a±c) + (b±d)i
- Method: 按多项式加减，合并同类项
- Key point: 实部与实部相加减，虚部与虚部相加减
- Example hint: 例1将展示具体计算

**Visual**:
- 中央：公式 "(a+bi) + (c+di) = (a+c) + (b+d)i"，白色粉笔
- 颜色标注：a,c（绿色，实部）；b,d（红色，虚部）
- 下方：减法公式，用粉色粉笔区分
- 右侧：手绘箭头标注 "实部±实部"、"虚部±虚部"
- 装饰：手绘加号、等号，粉笔痕迹

**Layout**: formula-derivation, 公式居中，标注清晰
