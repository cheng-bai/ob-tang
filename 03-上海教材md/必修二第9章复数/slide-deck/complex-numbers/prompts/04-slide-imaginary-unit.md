...
**Narrative Goal**: 定义虚数单位 i，这是复数体系的基石

**Key Content**:
- Headline: 虚数单位 i
- Definition: 规定 i² = -1
- Meaning: i 是 -1 的一个平方根
- Extension: (bi)² = -b²，负数开平方得以解决
- Key formula: i² = -1（黄色高亮）

**Visual**:
- 中央大号公式："i² = -1"，黄色粉笔，带星形高亮
- 下方推导："(bi)² = b²i² = -b²"，白色粉笔
- 右侧标注："解决负数开平方！"，绿色粉笔
- 装饰：手绘平方根符号 √、箭头指向

**Layout**: formula-center, 公式居中，推导在下方
