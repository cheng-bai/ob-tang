...
**Narrative Goal**: 清晰展示复平面的结构和坐标轴含义

**Key Content**:
- Headline: 复平面
- Definition: 表示复数的平面直角坐标系
- Real axis: x轴，表示实数（Re）
- Imaginary axis: y轴，表示虚数（Im）
- Point: 复数 z = a+bi 对应点 Z(a,b)
...
**Layout**: diagram-center, 图示居中，标注清晰
