...
**Slide 16/18 — 例题3：几何应用**

**Type**: Content

**Narrative Goal**: 展示平行四边形法则的具体应用

**Key Content**:
- Headline: 例题3 平行四边形顶点
- Given: 平行四边形 OABC，z_A = -1+i，z_C = 3+2i
- Find: 点 B 对应的复数
- Solution: z_B = z_A + z_C = 2+3i
