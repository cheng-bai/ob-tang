...
**Slide 13/18 — 9.2 复数的几何意义**

**Type**: Content

**Narrative Goal**: 引入复数的几何表示，建立代数与几何的联系

**Key Content**:
- Headline: 9.2 复数的几何意义
- Bridge: 从代数到几何的桥梁
- Correspondence:
  - 复数 z = a+bi
  - ↔ 有序实数对 (a,b)
...
- 中央：三个元素横向排列
  ...
  - "点 Z(a,b)"（绿色粉笔）
- 下方：手绘平面坐标系草图
- 装饰：手绘桥梁图案，连接"代数"与"几何"

**Layout**: concept-bridge, 概念映射图
