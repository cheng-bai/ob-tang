...
**Narrative Goal**: 展示复数除法的核心思想——分母实数化

**Key Content**:
- Headline: 复数的除法
- Method: 分子分母同乘分母的共轭复数
- Derivation: (a+bi)/(c+di) × (c-di)/(c-di) = [(ac+bd)+(bc-ad)i]/(c²+d²)
- Analogy: 类比"分母有理化"
- Key: 分母变为实数 c² + d²

**Visual**:
- 中央：分式 "(a+bi)/(c+di)"，大号白色粉笔
- 箭头指向："× (c-di)/(c-di)"，黄色粉笔
- 下方：推导结果，分步展示
- 右侧标注："分母实数化！"，绿色粉笔
- 装饰：手绘分式横线、箭头

**Layout**: formula-derivation, 推导过程清晰展示
