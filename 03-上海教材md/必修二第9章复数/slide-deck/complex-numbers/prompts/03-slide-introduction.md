...
**Slide 3/18 — 引入：负数开平方的问题**

**Type**: Content

**Narrative Goal**: 通过历史问题引出复数的必要性

**Key Content**:
- Headline: 一个困扰数学家的问题
- Problem: 实系数一元二次方程 x² + 1 = 0 没有实数解
- Question: 负数能开平方吗？
- History: 16世纪，数学家引入"虚数"解决此困境
- Key point: 实数与虚数合称为复数

**Visual**:
- 中央：手绘方程 "x² + 1 = 0"，大号白色粉笔
- 方程下方：红色粉笔标注 "无实数解！"
- 右侧：历史时间线草图，标注 "16世纪"
- 底部：黄色粉笔高亮 "引入虚数 i"
- 装饰：手绘问号、思考气泡

**Layout**: problem-solution, 左问题右历史
