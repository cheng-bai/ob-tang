...
定义 一个随机现象中依某个角度观察其所有可能出现(发生)的结果所组成的集合称为一个样本空间 (sample space),用 $\Omega$ 表示, 其中的元素称为基本事件 (elementary event) 或者样本点 (sample point). Q
...
在一个随机试验中, 有两个特别的事件. 一个必然发生, 称为必然事件,它对应的子集就是样本空间 $\Omega$ ,即所有基本事件的集合; 另外一个必然不发生, 称为不可能事件, 对应的子集是空集 $\varnothing$ . 它们统称为确定事件, 其余的称为不确定事件. Q
...
<table><tr><td>实验者</td><td>抛掷硬币次数</td><td>出现正面次数</td><td>频率</td></tr><tr><td>蒲丰</td><td>4 040</td><td>2048</td><td>0.5069</td></tr><tr><td>费勒</td><td>10000</td><td>4979</td><td>0.497 9</td></tr><tr><td>皮尔逊</td><td>12000</td><td>6019</td><td>0.5016</td></tr><tr><td>皮尔逊</td><td>24000</td><td>12 012</td><td>0.500 5</td></tr></table>
