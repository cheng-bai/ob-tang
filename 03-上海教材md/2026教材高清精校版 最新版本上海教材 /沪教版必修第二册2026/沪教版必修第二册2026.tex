...
本册教材图片提供 图虫网(封面一幅图，封底一幅图，P1一幅图，P50一幅图，P55一幅图， P98一幅图, P139一幅图); 全景网 (P61一幅图, P93一幅图); 有限公司 (P78一幅图)
...
\section*{6.1 正弦、余弦、正切、余切}

\section*{1 锐角的正弦、余弦、正切、余切}

\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_8_206_735_284_199_0.jpg}
\end{center}
\hspace*{3em} 
...
在小学和初中我们已经知道, 角是具有公共端点的两条射线所组成的图形, 角还可以看作是平面上由一条射线绕着其端点从初始位置(始边)旋转到终止位置(终边)所形成的图形(图 6-1-2). 我们以前学习过的锐角、直角、钝角、平角和周角, 其大小都在 \({0}^{ \circ  }\) 到 \({360}^{ \circ  }\) 之间. 不过在体操、跳水等体育运动中,会听到转体 720 \textdegree 、转体1 080 \textdegree 等术语；当手表比标准时间慢或者快 10 分钟的时候,只需要将分针旋转 \({60}^{ \circ  }\) 就可以调节准确,但也有按顺时针和逆时针方向旋转的差异. 因此, 要准确地刻画这些现象, 对于角而言, 不但要考察旋转量, 而且要考察旋转方向, 这就需要适当推广角的概念.

\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_9_1172_735_256_222_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.6\textwidth]{images/bo_d7fqtok91nqc7381i920_9_233_1475_780_282_0.jpg}
\end{center}
\hspace*{3em} 
...
解(1)因为 \(- {240}^{ \circ  } =  - {360}^{ \circ  } + {120}^{ \circ  }\) ,而 \({120}^{ \circ  }\) 的角属于第二象限, 所以 -240 \textdegree  的角属于第二象限.
...
(1)一315 \textdegree ； (2) \({905.3}^{ \circ  }\) ； (3)-1090 \textdegree ； (4) \({530}^{ \circ  }\) .
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_11_1158_788_284_259_0.jpg}
\end{center}
\hspace*{3em} 
...
\hline
角度 & \({0}^{ \circ  }\) & \({30}^{ \circ  }\) & \({45}^{ \circ  }\) & \({60}^{ \circ  }\) & \phantom{X} & \phantom{X} & 135 \textdegree  & \phantom{X} & 180 \textdegree  & \({270}^{ \circ  }\) & \({360}^{ \circ  }\) \\
\cline{1-12}
弧度 & \phantom{X} & \phantom{X} & \phantom{X} & \phantom{X} & \(\frac{\pi }{2}\) & \(\frac{2\pi }{3}\) & \phantom{X} & \(\frac{5\pi }{6}\) & \(\pi\) & \phantom{X} & \({2\pi }\) \\
\cline{1-12}
\hline
\end{tabular}
}
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_12_205_1549_284_253_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_14_201_459_292_233_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.5\textwidth]{images/bo_d7fqtok91nqc7381i920_14_692_1182_660_461_0.jpg}
\end{center}
\hspace*{3em} 
...
\hline
\multirow{2}{*}{角 \(\alpha\) 所属的象限} & \multicolumn{2}{|c|}{点 \(P\) 的坐标} & \multirow{2}{*}{\(\sin \alpha\)} & \multirow{2}{*}{\(\cos \alpha\)} & \multirow{2}{*}{\(\tan \alpha\)} & \multirow{2}{*}{\(\cot \alpha\)} \\
\cline{2-3}
 & \(x\) & \(y\) &  &  &  &  \\
\cline{1-7}
第一象限 & + & + & + & + & + & + \\
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d7fqtok91nqc7381i920_16_789_232_467_536_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_17_1130_230_343_292_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_17_1159_651_277_274_0.jpg}
\end{center}
\hspace*{3em} 
...
\hline
\(\alpha\) & 点 \(P\) 的坐标 & \(\sin \alpha\) & \(\cos \alpha\) & \(\tan \alpha\) & \(\cot \alpha\) \\
\cline{1-6}
\(\alpha  = {2k\pi }\left( {k \in  \mathbf{Z}}\right)\) & (1,0) & 0 & 1 & 0 & 不存在 \\
\cline{1-6}
\phantom{X} & (0,1) & \phantom{X} & \phantom{X} & \phantom{X} & \phantom{X} \\
\cline{1-6}
\phantom{X} & (-1,0) & \phantom{X} & \phantom{X} & \phantom{X} & \phantom{X} \\
\cline{1-6}
\phantom{X} & (0,-1) & \phantom{X} & \phantom{X} & \phantom{X} & \phantom{X} \\
\cline{1-6}
\hline
...
(3) \(\frac{1 + \cos \alpha }{\sin \alpha } = \frac{\sin \alpha }{1 - \cos \alpha }\) ；\_\_\_\_\_ Q
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_21_1161_974_278_273_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_21_1159_1605_278_272_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_22_209_347_274_271_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_23_1154_1787_282_276_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d7fqtok91nqc7381i920_26_165_332_364_280_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.8\textwidth]{images/bo_d7fqtok91nqc7381i920_27_144_349_964_341_0.jpg}
\end{center}
\hspace*{3em} 
...
A. -43 \textdegree 与 \({677}^{ \circ  }\) ; B. \({900}^{ \circ  }\) 与 \(- {1260}^{ \circ  }\) ;

C. -120 \textdegree 与 \({960}^{ \circ  }\) ; D. \({150}^{ \circ  }\) 与 \({630}^{ \circ  }\) .
...
(1) \({225}^{ \circ  }\) ; (2)1500 \textdegree ； (3) \(- {22}^{ \circ  }{30}^{\prime }\) ； (4) \(- {216}^{ \circ  }\) .
...
(1)若 \(\alpha\) 为第二象限的角，则 \({2\pi } - \alpha\) 为第\_\_\_\_\_象限的角；

(2)若角 \(\alpha\) 的终边与角 \(\beta\) 的终边关于 \(x\) 轴对称，则 \(\alpha\) 与 \(\beta\) 的关系是\_\_\_\_\_；

(3)若角 \(\alpha\) 与 \(\beta\) 满足关系 \(\alpha  = \left( {{2k} + 1}\right) \pi  - \beta \left( {k \in  \mathbf{Z}}\right)\) ，则角 \(\alpha\) 与 \(\beta\) 的终边关于\_\_\_\_\_ 对称.
...
\begin{center}
\includegraphics[max width=0.4\textwidth]{images/bo_d7fqtok91nqc7381i920_33_141_1520_472_276_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d7fqtok91nqc7381i920_33_663_1523_447_270_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_38_205_1865_282_194_0.jpg}
\end{center}
\hspace*{3em} 
...
(1) \(\frac{1}{2}\sin \alpha  + \frac{\sqrt{3}}{2}\cos \alpha\) ；\_\_\_\_\_
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_47_1144_1773_329_287_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_49_1173_1073_257_212_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_49_1139_1599_321_208_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_51_1152_227_295_249_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_56_178_1357_338_495_0.jpg}
\end{center}
\hspace*{3em} 

\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_56_188_1910_319_143_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_57_1148_778_306_270_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_58_1214_227_292_275_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.6\textwidth]{images/bo_d7fqtok91nqc7381i920_58_431_1810_818_354_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d7fqtok91nqc7381i920_59_1109_1296_359_275_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d7fqtok91nqc7381i920_61_148_410_466_361_0.jpg}
\end{center}
\hspace*{3em} 
...
(1)若 \(\theta\) 为锐角,则 \({\log }_{\sin \theta }\left( {1 + {\cot }^{2}\theta }\right)  =\) \_\_\_\_\_；

(2)若 \(- \frac{\pi }{2} < \alpha  < 0\) ，则点 \(\left( \right. \cot \alpha ,\cos \alpha\) ) 必在第\_\_\_\_\_象限；

(3)若 \(\sin \left( {\pi  - \alpha }\right)  = \frac{2}{3},\alpha  \in  \left( {\frac{\pi }{2},\pi }\right)\) ，则 \(\sin {2\alpha } =\) \_\_\_\_\_.
...
(1)若 \(0 < x < \frac{\pi }{4}\) ，且 \(\lg \left( {\sin x + \cos x}\right)  = \frac{1}{2}\left( {3\lg 2 - \lg 5}\right)\) ，则 \(\cos x - \sin x\) 的值为\_\_( )
...
(1)在 \(\bigtriangleup  {ABC}\) 中，若 \({a}^{2} + {b}^{2} + {ab} = {c}^{2}\) ，则 \(C =\) \_\_\_\_\_；

(2)若 \(\sin \theta  = a,\cos \theta  =  - {2a}\) ，且 \(\theta\) 为第四象限的角，则实数 \(a =\) \_\_\_\_\_.
...
\begin{tabular}{|c|c|c|c|c|c|}
\hline
\(\theta\) & 1 & 0.5 & 0.1 & 0.01 & 0.001 \\
\cline{1-6}
\(\sin \theta\) & \phantom{X} & \phantom{X} & \phantom{X} & \phantom{X} & \phantom{X} \\
\cline{1-6}
\(\frac{\sin \theta }{\theta }\) & \phantom{X} & \phantom{X} & \phantom{X} & \phantom{X} & \phantom{X} \\
\cline{1-6}
\hline
\end{tabular}
}
...
(1) \circled{1}  \(a = 6\) ， \circled{2}  \(a = 9\) ， \circled{3}  \(a = {13}\) ， \circled{4}  \(a = {18}\) ， \circled{5}  \(a = {22}\) ；
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_65_1179_1793_292_298_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=1.0\textwidth]{images/bo_d7fqtok91nqc7381i920_67_0_0_1654_1028_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.4\textwidth]{images/bo_d7fqtok91nqc7381i920_68_774_1802_500_258_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.6\textwidth]{images/bo_d7fqtok91nqc7381i920_69_228_757_792_314_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.7\textwidth]{images/bo_d7fqtok91nqc7381i920_69_173_1619_903_219_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.4\textwidth]{images/bo_d7fqtok91nqc7381i920_70_749_290_544_249_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.4\textwidth]{images/bo_d7fqtok91nqc7381i920_70_787_1380_472_278_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.6\textwidth]{images/bo_d7fqtok91nqc7381i920_74_444_1040_786_169_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_74_863_1762_320_281_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_77_1163_511_273_175_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d7fqtok91nqc7381i920_77_1110_1714_361_315_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.5\textwidth]{images/bo_d7fqtok91nqc7381i920_79_329_455_590_259_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_81_1183_1332_285_264_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_81_1128_1959_343_96_0.jpg}
\end{center}
\hspace*{3em} 
...
(3) \(y = 2\sin x - 5,x \in  \left\lbrack  {-\frac{\pi }{3},\frac{5\pi }{6}}\right\rbrack\) ；\_\_\_\_\_ (4) \(y = {\cos }^{2}x - \sin x,x \in  \mathbf{R}\) .
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_83_222_806_322_208_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.5\textwidth]{images/bo_d7fqtok91nqc7381i920_83_757_740_635_279_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.8\textwidth]{images/bo_d7fqtok91nqc7381i920_84_551_1714_944_220_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_84_221_1773_254_192_0.jpg}
\end{center}
\hspace*{3em} 
...
\section*{7.3 函数 \(y = A\sin \left( {{\omega x} + \varphi }\right)\) 的图像}
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_88_196_631_303_303_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_88_176_1551_340_90_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.7\textwidth]{images/bo_d7fqtok91nqc7381i920_89_184_711_882_347_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{tabular}{|c|c|c|c|c|c|}
\hline
\(t = {2x} + \frac{\pi }{4}\) & 0 & \(\frac{\pi }{2}\) & \(\pi\) & \(\frac{3\pi }{2}\) & \({2\pi }\) \\
\cline{1-6}
\(x\) & \(- \frac{\pi }{8}\) & \(\frac{\pi }{8}\) & \(\frac{3\pi }{8}\) & \(\frac{5\pi }{8}\) & \(\frac{7\pi }{8}\) \\
\cline{1-6}
\(3\sin \left( {{2x} + \frac{\pi }{4}}\right)\) & 0 & 3 & 0 & -3 & 0 \\
\cline{1-6}
\hline
\end{tabular}
}
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d7fqtok91nqc7381i920_90_794_1252_455_327_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.5\textwidth]{images/bo_d7fqtok91nqc7381i920_90_711_1880_620_231_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d7fqtok91nqc7381i920_91_582_1365_451_293_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{tabular}{|c|c|c|c|c|}
\hline
时间/h & \(1\frac{13}{20}\) & \(8\frac{19}{30}\) & 13 \(\frac{53}{60}\) & 20 \(\frac{7}{10}\) \\
\cline{1-5}
...
\begin{center}
\includegraphics[max width=0.6\textwidth]{images/bo_d7fqtok91nqc7381i920_92_443_544_792_424_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.6\textwidth]{images/bo_d7fqtok91nqc7381i920_93_406_956_808_153_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_94_1207_376_295_274_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d7fqtok91nqc7381i920_94_1062_998_439_241_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_95_1182_1110_236_343_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d7fqtok91nqc7381i920_95_404_1398_444_498_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.4\textwidth]{images/bo_d7fqtok91nqc7381i920_96_759_659_528_301_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_99_408_242_338_235_0.jpg}
\end{center}
\hspace*{3em} 

\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_99_893_262_319_216_0.jpg}
\end{center}
\hspace*{3em} 
...
\cline{1-4}
定义域 & \(\mathbf{R}\) & \(\mathbf{R}\) & \(\left\langle  {x\left| {\;x \in  \mathbf{R},x \neq  {k\pi } + \frac{\pi }{2}\left( {k \in  \mathbf{Z}}\right) }\right. }\right\rangle\) \\
\cline{1-4}
值域 & [-1,1] & \(\left\lbrack  {-1,1}\right\rbrack\) & \(\mathbf{R}\) \\
\cline{1-4}
最大值 & 1 & 1 & 无 \\
\cline{1-4}
最小值 & -1 & -1 & 无 \\
...
奇偶性 & 奇函数 & 偶函数 & 奇函数 \\
\cline{1-4}
单调增区间 & \(\left\lbrack  {{2k\pi } - \frac{\pi }{2},{2k\pi } + \frac{\pi }{2}}\right\rbrack  \left( {k \in  \mathbf{Z}}\right)\) & \(\left\lbrack  {{2k\pi } - \pi ,{2k\pi }}\right\rbrack  \left( {k \in  \mathbf{Z}}\right)\) & \(\left( {{k\pi } - \frac{\pi }{2},{k\pi } + \frac{\pi }{2}}\right) \left( {k \in  \mathbf{Z}}\right)\) \\
\cline{1-4}
单调减区间 & \(\left\lbrack  {{2k\pi } + \frac{\pi }{2},{2k\pi } + \frac{3\pi }{2}}\right\rbrack  \left( {k \in  \mathbf{Z}}\right)\) & \(\left\lbrack  {{2k\pi },{2k\pi } + \pi }\right\rbrack  \left( {k \in  \mathbf{Z}}\right)\) & 无 \\
\cline{1-4}
图像 & \includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_100_403_1114_331_149_0.jpg} & \includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_100_764_1117_321_150_0.jpg} & \includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_100_1120_1112_345_161_0.jpg} \\
\cline{1-4}
\hline
\end{tabular}
}
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d7fqtok91nqc7381i920_101_1116_1827_354_253_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_102_1161_1745_343_335_0.jpg}
\end{center}
\hspace*{3em} 
...
\section*{8.1 向量的概念和线性运算}

\section*{1 向量的概念}

\begin{center}
\includegraphics[max width=0.8\textwidth]{images/bo_d7fqtok91nqc7381i920_104_549_760_952_229_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d7fqtok91nqc7381i920_105_432_465_388_256_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_105_1131_1142_343_166_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_105_1142_1487_319_286_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_106_452_929_278_314_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_106_947_983_278_262_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.5\textwidth]{images/bo_d7fqtok91nqc7381i920_106_721_1917_612_180_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_107_216_631_301_194_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_107_737_687_298_136_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.7\textwidth]{images/bo_d7fqtok91nqc7381i920_107_210_1782_831_191_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_108_221_1751_255_281_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_109_1161_805_277_256_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d7fqtok91nqc7381i920_109_1114_1478_377_203_0.jpg}
\end{center}
\hspace*{3em} 
...
(1) \(\overrightarrow{AB} - \overrightarrow{AC} =\) \_\_\_\_\_； (2) \(\overrightarrow{BC} - \overrightarrow{AC} =\)
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d7fqtok91nqc7381i920_110_844_797_357_264_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_112_196_1534_301_214_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_113_1159_667_311_267_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d7fqtok91nqc7381i920_114_305_285_373_247_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.4\textwidth]{images/bo_d7fqtok91nqc7381i920_114_890_426_491_115_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d7fqtok91nqc7381i920_115_610_281_396_297_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.4\textwidth]{images/bo_d7fqtok91nqc7381i920_115_571_1031_473_145_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.6\textwidth]{images/bo_d7fqtok91nqc7381i920_116_632_801_776_146_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.6\textwidth]{images/bo_d7fqtok91nqc7381i920_116_633_1762_779_146_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_117_1164_219_271_257_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.7\textwidth]{images/bo_d7fqtok91nqc7381i920_117_203_951_844_222_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d7fqtok91nqc7381i920_118_164_891_367_329_0.jpg}
\end{center}
\hspace*{3em} 
...
\section*{2 向量的数量积的定义与运算律}

\HRule

数量积又称为标量积, 也称为内积 (inner product) 或点积 (dot product). 记号 \(\overrightarrow{a} \cdot  \overrightarrow{b}\) 中间的“ \(\cdot\) ”不可以省略, 也不可以用 “ \ding{55} ”代替.
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_119_1158_687_285_281_0.jpg}
\end{center}
\hspace*{3em} 
...
(1)设向量 \(\overrightarrow{a}\) 、 \(\overrightarrow{b}\) 满足 \(\left| \overrightarrow{a}\right|  = 4\) ， \(\left| \overrightarrow{b}\right|  = 9\) ， \(\langle \overrightarrow{a},\overrightarrow{b}\rangle  = \frac{\pi }{6}\) ，则 \(\overrightarrow{a} \cdot  \left( {\overrightarrow{a} - \overrightarrow{b}}\right)  =\) \_\_\_\_\_；

(2)设向量 \(\overrightarrow{a}\) 、 \(\overrightarrow{b}\) 满足 \(\left| \overrightarrow{a}\right|  = 5\) ， \(\left| \overrightarrow{b}\right|  = 6\) ， \(\left( {\overrightarrow{a} + \overrightarrow{b}}\right)  \cdot  \overrightarrow{b} = {21}\) ，则 \(\langle \overrightarrow{a},\overrightarrow{b}\rangle  =\) \_\_\_\_\_.
...
1. 设向量 \(\overrightarrow{a}\) 、 \(\overrightarrow{b}\) 满足 \(\left| \overrightarrow{a}\right|  = 6\) ， \(\left| \overrightarrow{b}\right|  = 3\) ，且 \(\overrightarrow{a} \cdot  \overrightarrow{b} =  - {12}\) ，则向量 \(\overrightarrow{a}\) 在向量 \(\overrightarrow{b}\) 方向上的投影是\_\_\_\_\_.

2. 在 \(\bigtriangleup {ABC}\) 中,若 \(\left| {AB}\right|  = 3,\left| {AC}\right|  = 2,\left| {BC}\right|  = \sqrt{10}\) ,则 \(\overrightarrow{AB} \cdot  \overrightarrow{AC} =\) \_\_\_\_\_.

3. 已知向量 \(\overrightarrow{a}\) 与 \(\overrightarrow{b}\) 的夹角为 \({45}^{ \circ  }\) ,且 \(\left| \overrightarrow{a}\right|  = 1,\left| {2\overrightarrow{a} - \overrightarrow{b}}\right|  = \sqrt{10}\) ,则 \(\left| \overrightarrow{b}\right|  =\) \_\_\_\_\_.

4. 在菱形 \({ABCD}\) 中， \(\left( {\overrightarrow{AB} + \overrightarrow{AD}}\right)\) - \(\left( {\overrightarrow{AB} - \overrightarrow{AD}}\right)  =\) \_\_\_\_\_.
...
1. 在 \(\bigtriangleup {ABC}\) 中,若 \(\left| {AB}\right|  = 2,\left| {AC}\right|  = 3,\overrightarrow{AB} \cdot  \overrightarrow{BC} = 1\) ,则 \(\left| {BC}\right|  =\) \_\_\_\_\_.
...
4. 在直角三角形 \({ABC}\) 中,若 \(D\) 是斜边 \({AB}\) 的中点, \(P\) 为线段 \({CD}\) 的中点,则 \(\frac{{\left| PA\right| }^{2} + {\left| PB\right| }^{2}}{{\left| PC\right| }^{2}} =\) \_\_\_\_\_.

5. 在 \(\bigtriangleup {ABC}\) 中,设 \(M\) 是 \({BC}\) 的中点,且 \(\left| {AM}\right|  = 3,\left| {BC}\right|  = {10}\) ,则 \(\overrightarrow{AB} \cdot  \overrightarrow{AC} =\) \_\_\_\_\_.
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_123_1154_1485_291_242_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.7\textwidth]{images/bo_d7fqtok91nqc7381i920_124_579_1227_888_334_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_125_1141_625_318_179_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_125_1176_1719_294_236_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_126_1207_400_295_298_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_126_180_1366_335_163_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_127_1151_230_298_299_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_131_1144_1181_326_157_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d7fqtok91nqc7381i920_133_1121_1785_360_236_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_134_188_832_318_163_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d7fqtok91nqc7381i920_134_160_1803_375_214_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_135_1194_973_279_274_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_135_1160_1397_277_275_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d7fqtok91nqc7381i920_136_156_881_379_282_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.6\textwidth]{images/bo_d7fqtok91nqc7381i920_137_267_232_714_389_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d7fqtok91nqc7381i920_138_1142_902_357_177_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_139_1147_238_303_505_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_141_1158_1557_313_239_0.jpg}
\end{center}
\hspace*{3em} 
...
4. 在矩形 \({ABCD}\) 中,边 \({AB}\text{ 、 }{AD}\) 的长分别为 \(2\text{ 、 }1\) ,若 \(M\text{ 、 }N\) 分别是边 \({BC}\text{ 、 }{CD}\) 上的点，且满足 \(\frac{\left| \overrightarrow{BM}\right| }{\left| \overrightarrow{BC}\right| } = \frac{\left| \overrightarrow{CN}\right| }{\left| \overrightarrow{CD}\right| }\) ，则 \(\overrightarrow{AM} \cdot  \overrightarrow{AN}\) 的取值范围是\_\_\_\_\_.
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_142_1165_837_339_267_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_142_435_1669_324_194_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_142_971_1518_278_348_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_143_410_812_315_295_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_143_872_841_335_267_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=1.0\textwidth]{images/bo_d7fqtok91nqc7381i920_145_0_0_1654_1015_0.jpg}
\end{center}
\hspace*{3em} 
...
\section*{9.1 复数及其四则运算}

\section*{1 复数的引入与复数的四则运算}
...
\begin{tabular}{|c|c|c|c|c|c|c|}
\hline
Z & 是否复数 & 是否实数 & 是否虚数 & 是否纯虚数 & \(\operatorname{Re}z\) & \(\operatorname{Im}z\) \\
\cline{1-7}
-0.5i & \phantom{X} & \phantom{X} & \phantom{X} & \phantom{X} & \phantom{X} & \phantom{X} \\
\cline{1-7}
\(- \frac{1}{2} - \sqrt{2}\mathrm{i}\) & \phantom{X} & \phantom{X} & \phantom{X} & \phantom{X} & \phantom{X} & \phantom{X} \\
\cline{1-7}
\(\pi\) & \phantom{X} & \phantom{X} & \phantom{X} & \phantom{X} & \phantom{X} & \phantom{X} \\
\cline{1-7}
0 & \phantom{X} & \phantom{X} & \phantom{X} & \phantom{X} & \phantom{X} & \phantom{X} \\
\cline{1-7}
\(\sqrt{3}\) & \phantom{X} & \phantom{X} & \phantom{X} & \phantom{X} & \phantom{X} & \phantom{X} \\
\cline{1-7}
2i-5 & \phantom{X} & \phantom{X} & \phantom{X} & \phantom{X} & \phantom{X} & \phantom{X} \\
\cline{1-7}
\hline
\end{tabular}
}
...
\begin{tabular}{|c|c|c|c|c|c|c|}
\hline
\(z\) & 是否复数 & 是否实数 & 是否虚数 & 是否纯虚数 & \(\operatorname{Re}z\) & Im \(z\) \\
\cline{1-7}
-0.5i & 是 & 否 & 是 & 是 & 0 & -0.5 \\
\cline{1-7}
\(- \frac{1}{2} - \sqrt{2}\mathrm{i}\) & 是 & 否 & 是 & 否 & \(- \frac{1}{2}\) & \(- \sqrt{2}\) \\
\cline{1-7}
\(\pi\) & 是 & 是 & 否 & 否 & \(\pi\) & 0 \\
\cline{1-7}
0 & 是 & 是 & 否 & 否 & 0 & 0 \\
\cline{1-7}
\(\sqrt{3}\) & 是 & 是 & 否 & 否 & \(\sqrt{3}\) & 0 \\
\cline{1-7}
2i-5 & 是 & 否 & 是 & 否 & -5 & 2 \\
\cline{1-7}
\hline
...
(1) \(\left( {\frac{1}{4} - \frac{13}{5}\mathrm{i}}\right)  + \left( {\frac{2}{3} + \frac{5}{2}\mathrm{i}}\right)\) ；\_\_\_\_\_ (2) \(- \left( {3 - {4i}}\right)  + \left( {2 + \mathrm{i}}\right)  - \left( {1 - {5i}}\right)\) ；
...
(1) \({\left( \frac{1 - \mathrm{i}}{1 + \mathrm{i}}\right) }^{3}\) ； (2) \(\frac{-2 + 2\sqrt{3}\mathrm{i}}{{\left( \sqrt{3} + \mathrm{i}\right) }^{2}}\) ；\_\_\_\_\_
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_156_230_981_234_256_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_156_229_1447_239_408_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_157_1182_459_234_255_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d7fqtok91nqc7381i920_157_1111_920_352_308_0.jpg}
\end{center}
\hspace*{3em} 
...
\section*{3 复数加法的平行四边形法则}

我们已经知道向量的加法适用平行四边形法则, 在将复数与平面向量建立一一对应后, 两个复数的和是否与对应的向量的和一致呢? 也就是说, 在复平面上是否也可以用平行四边形法则表述复数的加法呢?

\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d7fqtok91nqc7381i920_158_151_679_389_277_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_158_186_1109_322_244_0.jpg}
\end{center}
\hspace*{3em} 
...
(1) \(\frac{\left( {1 - i}\right) \left( {1 + {2i}}\right) }{4 + {3i}}\) ；\_\_\_\_\_
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_161_1141_230_316_232_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_168_217_1087_261_256_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_170_250_1830_193_216_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.7\textwidth]{images/bo_d7fqtok91nqc7381i920_172_580_833_886_312_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_172_222_1748_253_309_0.jpg}
\end{center}
\hspace*{3em} 
...
(2) \(\frac{{12}\left( {\cos \frac{11\pi }{6} + \mathrm{i}\sin \frac{11\pi }{6}}\right) }{6\left( {\cos \frac{2\pi }{3} + \mathrm{i}\sin \frac{2\pi }{3}}\right) }\) ; (3) \(\frac{\sqrt{3}\left( {\cos {150}^{ \circ  } + \mathrm{i}\sin {150}^{ \circ  }}\right) }{\sqrt{2}\left( {\cos {300}^{ \circ  } + \mathrm{i}\sin {300}^{ \circ  }}\right) }\) ；\_\_\_\_\_
...
(1)设 \(z = {11} - {{60}\mathrm{i}}\) ，则 \(\operatorname{Re}z =\) \_\_\_\_\_； \(\left| z\right|  =\) \_\_\_\_\_； \(\left| z\right|  =\) \_\_\_\_\_； \(\bar{z} =\) \_\_\_\_\_.

(2)下列三个命题中，真命题是\_\_\_\_\_.

 \circled{1}  在复平面上, 表示实数的点都在实轴上, 表示虚数的点都在虚轴上;

 \circled{2}  任何一个表示虚数的点一定在某一个象限内;

 \circled{3}  复数的模表示该复数在复平面上所对应的点到原点的距离.
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_191_1323_722_140_147_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_191_687_1911_167_163_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_192_1325_737_141_148_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_192_1314_1236_166_164_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_194_1110_1993_163_67_0.jpg}
\end{center}
\hspace*{3em} 
...
\cline{1-5}
图象 & \includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_195_374_1510_85_93_0.jpg} & \includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_195_483_1510_90_94_0.jpg} & \includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_195_587_1512_100_89_0.jpg} & \includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_195_699_1512_99_89_0.jpg} \\
\cline{1-5}
开口方向 & 向右 & 向左 & 向上 & 向下 \\
\cline{1-5}
...
\begin{center}
\includegraphics[max width=1.0\textwidth]{images/bo_d7fqtok91nqc7381i920_196_215_416_1222_492_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=1.0\textwidth]{images/bo_d7fqtok91nqc7381i920_196_210_1109_1233_560_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d7fqtok91nqc7381i920_197_402_367_379_221_0.jpg}
\end{center}
\hspace*{3em} 

\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d7fqtok91nqc7381i920_197_845_333_394_256_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=1.0\textwidth]{images/bo_d7fqtok91nqc7381i920_198_238_382_1281_1625_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=1.0\textwidth]{images/bo_d7fqtok91nqc7381i920_199_237_357_1328_1169_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=1.0\textwidth]{images/bo_d7fqtok91nqc7381i920_199_242_1643_1243_433_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.5\textwidth]{images/bo_d7fqtok91nqc7381i920_200_222_295_642_483_0.jpg}
\end{center}
\hspace*{3em} 

\begin{center}
\includegraphics[max width=0.5\textwidth]{images/bo_d7fqtok91nqc7381i920_200_879_333_589_371_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d7fqtok91nqc7381i920_200_225_1222_398_301_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.9\textwidth]{images/bo_d7fqtok91nqc7381i920_201_203_347_1154_604_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.9\textwidth]{images/bo_d7fqtok91nqc7381i920_201_201_1085_1132_528_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.9\textwidth]{images/bo_d7fqtok91nqc7381i920_201_198_1728_1150_428_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_202_321_371_104_110_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_202_453_372_101_110_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_202_582_372_103_110_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_202_709_373_103_109_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_202_330_574_88_93_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_202_461_574_85_93_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_202_591_574_85_93_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_202_718_575_87_92_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_202_432_789_290_135_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_202_918_273_98_100_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_202_1051_272_98_101_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_202_1180_271_100_102_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_202_1308_271_99_102_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_202_1106_491_132_135_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_202_1083_784_177_180_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_202_334_1250_137_122_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_202_517_1250_127_122_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_202_693_1250_132_121_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_202_335_1377_130_124_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_202_516_1376_129_126_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_202_693_1378_131_124_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_202_333_1598_125_121_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_202_516_1594_120_123_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_202_694_1594_121_123_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_202_334_1721_169_169_0.jpg}
\end{center}
\hspace*{3em} 

\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_202_514_1720_164_169_0.jpg}
\end{center}
\hspace*{3em} 

\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_202_691_1751_166_141_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_202_923_1196_177_184_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_202_1208_1227_104_154_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_202_964_1462_276_106_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_202_1291_1620_116_177_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_202_1116_1636_154_163_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_202_905_1648_180_135_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_204_1068_1473_178_444_0.jpg}
\end{center}
\hspace*{3em} 
...
\phantom{X} & 23. & 公式中中文 \\
\cline{1-3}
\phantom{X} & 24. & \includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_204_383_2030_60_97_0.jpg} \\
\cline{1-3}
\hline
\end{tabular}
}
...
\begin{center}
\includegraphics[max width=1.0\textwidth]{images/bo_d7fqtok91nqc7381i920_207_129_129_1417_2097_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=1.0\textwidth]{images/bo_d7fqtok91nqc7381i920_208_161_157_1441_1269_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=1.0\textwidth]{images/bo_d7fqtok91nqc7381i920_208_160_1539_1372_478_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.5\textwidth]{images/bo_d7fqtok91nqc7381i920_209_168_103_677_501_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=1.0\textwidth]{images/bo_d7fqtok91nqc7381i920_209_157_735_1481_754_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.9\textwidth]{images/bo_d7fqtok91nqc7381i920_209_158_1612_1057_478_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=1.0\textwidth]{images/bo_d7fqtok91nqc7381i920_210_144_153_1206_565_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=1.0\textwidth]{images/bo_d7fqtok91nqc7381i920_210_148_826_1214_455_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.7\textwidth]{images/bo_d7fqtok91nqc7381i920_210_153_1388_841_844_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_211_186_296_187_201_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_211_449_298_187_199_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_211_712_298_187_199_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_211_974_299_187_199_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_211_202_688_155_169_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_211_464_689_155_168_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_211_728_689_154_168_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_211_990_689_155_168_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d7fqtok91nqc7381i920_211_377_1093_524_243_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_211_1300_176_182_176_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_211_1566_175_177_178_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_211_1827_174_179_178_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_211_2089_177_179_176_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_211_2001_545_241_248_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_211_1995_909_250_238_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_212_198_279_253_219_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_212_531_279_241_220_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_212_859_278_242_220_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_212_198_511_241_226_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_212_531_510_240_229_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_212_859_510_242_231_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_212_200_922_223_215_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_212_529_913_224_222_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_212_859_909_225_222_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_212_198_1150_301_306_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_212_531_1143_303_314_0.jpg}
\end{center}
\hspace*{3em} 

\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_212_861_1203_303_253_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_212_1316_229_298_295_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_212_1816_232_193_290_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.3\textwidth]{images/bo_d7fqtok91nqc7381i920_212_1362_670_512_195_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_212_1984_972_196_313_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_212_1322_1014_264_258_0.jpg}
\end{center}
\hspace*{3em} 
...
\begin{center}
\includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_212_1650_1018_275_267_0.jpg}
\end{center}
\hspace*{3em} 
...
标准方程 \(\left( {p > 0}\right)\) & \({y}^{2} = {2px}\) & \({y}^{2} =  - {2px}\) & \({x}^{2} = {2py}\) & \({x}^{2} =  - {2py}\) \\
\cline{1-5}
图象 & \includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_213_309_523_145_163_0.jpg} & \includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_213_500_523_155_164_0.jpg} & \includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_213_682_526_172_156_0.jpg} & \includegraphics[max width=0.2\textwidth]{images/bo_d7fqtok91nqc7381i920_213_874_530_171_151_0.jpg} \\
\cline{1-5}
开口方向 & 向右 & 向左 & 向上 & 向下 \\
\cline{1-5}
焦点坐标 & \(P\left( {\frac{p}{2},0}\right)\) & \(P\left( {-\frac{p}{2},0}\right)\) & \(P\left( {0,\frac{p}{2}}\right)\) & \(P\left( {0, - \frac{p}{2}}\right)\) \\
